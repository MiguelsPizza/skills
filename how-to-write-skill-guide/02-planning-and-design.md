...
*Real example:* [frontend-design skill](https://github.com/anthropics/skills) (also see [skills for docx, pptx, xlsx, and ppt](https://github.com/anthropics/skills))
...
*Real example:* [sentry-code-review skill (from Sentry)](https://github.com/getsentry/sentry-mcp)
...
Keep SKILL.md focused on core instructions. Move detailed documentation to `references/` and link to it. (See [Core Design Principles](01-fundamentals.md#core-design-principles) for how the three-level system works.)
