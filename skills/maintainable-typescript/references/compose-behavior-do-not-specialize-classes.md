...
See also: [No Premature Abstractions](no-premature-abstractions.md) and [Your Pattern Will Be Copied](your-pattern-will-be-copied.md).
...
Example implements: [Compose Behavior, Do Not Specialize Classes](compose-behavior-do-not-specialize-classes.md), [No Premature Abstractions](no-premature-abstractions.md), [Your Pattern Will Be Copied](your-pattern-will-be-copied.md).
## The rule of thumb
