...
See also: [Maintainability Equals Correctness](maintainability-equals-correctness.md), [Your Pattern Will Be Copied](your-pattern-will-be-copied.md), and [Delete Shape Churn](delete-shape-churn.md).
