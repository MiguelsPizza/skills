...
See also: [Split By Stable Seam](split-by-stable-seam.md) and [Naming Is Navigation](naming-is-navigation.md).
...
Example implements: [Build Deep Modules, Not Shallow Abstractions](build-deep-modules-not-shallow-abstractions.md), [Split By Stable Seam](split-by-stable-seam.md), [Naming Is Navigation](naming-is-navigation.md).
## The smell
