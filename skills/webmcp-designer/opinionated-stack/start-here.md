...
See also: [Module-Local WebMCP Directories](module-local-webmcp-directories.md) and [Thin Wrappers Over Existing Logic](thin-wrappers-over-existing-logic.md).
...
Example implements: [Start Here](start-here.md), [Module-Local WebMCP Directories](module-local-webmcp-directories.md), [Thin Wrappers Over Existing Logic](thin-wrappers-over-existing-logic.md).
