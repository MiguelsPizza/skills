...
See also: [Start Here](./start-here.md) and [Implementation Patterns](./implementation-patterns.md).
...
5. Read the smallest additional doctrine set needed for the target app:
   - route shape: [Route Maps Drive Discovery](../doctrine/route-maps-drive-discovery.md)
   - read tools: [Read Tools Live at Data Boundaries](../doctrine/read-tools-live-at-data-boundaries.md)
   - tool separation: [Tool Types Have Clear Boundaries](../doctrine/tool-types-have-clear-boundaries.md)
   - forms and commits: [Stage Forms, Then Commit](../doctrine/stage-forms-then-commit.md)
   - tool shape: [Capabilities Over Click Targets](../doctrine/capabilities-over-click-targets.md)
   - workflow writing: [User Stories Drive Web Skills](../doctrine/user-stories-drive-web-skills.md)
...
1. Read SKILL.md.
2. Read stack/one-pass-instrumentation-plan.md.
...
Example implements: [One-Pass Instrumentation Plan](./one-pass-instrumentation-plan.md), [Start Here](./start-here.md), [Implementation Patterns](./implementation-patterns.md).
